...
class DualHandTest:
    ...
    def draw_hand_landmarks(self, frame, hand_landmarks, hand_idx):
        color_map = {0: (0, 255, 0), 1: (255, 0, 0)}
        color = color_map.get(hand_idx, (0, 255, 255))
            ...
            while True:
                ...
                if result.hand_landmarks:
                    for idx, hand_landmarks in enumerate(result.hand_landmarks):
                        self.draw_hand_landmarks(frame, [hand_landmarks], idx)
                    cv2.putText(
                        frame,
