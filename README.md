...
## 📁 仓库文件夹结构
严格遵循「学习阶段隔离、笔记代码分离、数据模型统一管理」的原则，结构如下，完全兼容GitHub文件树渲染：
```plaintext
Sum/
...
│
├── 配置检查/                   # 环境检查脚本、一键安装指令、踩坑记录
│  
├── learn/                      # 通用学习笔记、Python基础、Git教程等前置知识
...
| 时间 | 更新内容 |
| :--- | :--- |
| 2026.04 | 仓库初始化，完成README文档、文件夹结构规划、环境配置脚本 |
| 2026.04 | 完成cv-yolo环境RTX5060显卡适配，解决CUDA兼容报错问题 |
| 2026.04 | 新增YOLOv8实时检测案例、环境检查工具 |
